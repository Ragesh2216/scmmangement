...
const InventoryOptimization = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-green-50 pt-16">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-r from-gray-900 to-green-800 text-white py-12 lg:py-20">
        ...
        <div className="absolute top-0 left-0 w-full h-full">
          <motion.div
            ...
            className="absolute top-10 left-10 w-16 h-16 lg:w-20 lg:h-20 bg-green-500 rounded-full opacity-20"
          ></motion.div>
          <motion.div
            animate={{
              y: [0, 15, 0],
            ...
            className="absolute top-40 right-10 lg:right-20 w-12 h-12 lg:w-16 lg:h-16 bg-blue-500 rounded-full opacity-20"
          ></motion.div>
          <motion.div
            animate={{
              scale: [1, 1.2, 1],
            ...
            className="absolute bottom-20 left-1/4 w-8 h-8 lg:w-12 lg:h-12 bg-purple-500 rounded-full opacity-20"
          ></motion.div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 lg:mb-6 bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent">
        ...
        <motion.div
          ...
          className="relative max-w-4xl mx-auto mt-8 lg:mt-12 px-4"
        >
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 lg:p-6 border border-white/20">
            <div className="flex flex-col sm:flex-row items-center justify-between mb-4 gap-2">
              <div className="text-white font-semibold text-lg">Inventory Level Optimization</div>
              <div className="text-green-300 text-sm">Live Demo</div>
            </div>
            <div className="h-24 lg:h-32 bg-black/20 rounded-lg p-4">
              <div className="flex items-end justify-between h-full space-x-1 lg:space-x-2">
                {[30, 45, 60, 80, 95, 75, 65, 55, 70, 85, 90, 75].map((height, index) => (
                  <motion.div
                    ...
                    className={`w-4 lg:w-8 rounded-t-lg ${
        ...
        <div className="absolute bottom-0 left-0 w-full h-12 lg:h-20 bg-gradient-to-t from-green-50 to-transparent"></div>
      </section>
      ...
      {/* Stats Section */}
      <section className="py-12 lg:py-20 bg-gradient-to-r from-green-900 to-blue-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            {optimizationStats.map((stat, index) => (
              ...
              >
                <div className="w-12 h-12 lg:w-16 lg:h-16 bg-green-500 rounded-2xl flex items-center justify-center text-white mb-3 lg:mb-4 mx-auto">
                  {stat.icon}
                </div>
                <motion.div 
                  className="text-2xl lg:text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent"
                  initial={{ scale: 0 }}
                  whileInView={{ scale: 1 }}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 lg:gap-8 relative z-10">
              {optimizationProcess.map((step, index) => (
                <motion.div
                  ...
                  whileHover={{ scale: 1.05 }}
                  className="bg-white rounded-2xl p-4 lg:p-6 shadow-lg border border-gray-100 text-center group hover:shadow-2xl transition-all duration-500"
                >
                  <div className="w-10 h-10 lg:w-12 lg:h-12 bg-gradient-to-r from-green-500 to-blue-500 rounded-full flex items-center justify-center text-white font-bold text-base lg:text-lg mb-3 lg:mb-4 mx-auto group-hover:scale-110 transition-transform duration-300">
                    {step.step}
                  </div>
                  <div className="w-12 h-12 lg:w-16 lg:h-16 bg-green-100 rounded-2xl flex items-center justify-center text-green-600 mb-3 lg:mb-4 mx-auto group-hover:bg-green-200 transition-colors duration-300">
                    {step.icon}
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {benefitsData.map((benefit, index) => (
              <motion.div
                ...
                transition={{ duration: 0.6, delay: index * 0.2 }}
                whileHover={{ y: -5 }}
                className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-6 lg:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 relative overflow-hidden"
              >
                ...
                <motion.div
                  ...
                  className="text-3xl lg:text-4xl font-bold text-center mb-3 lg:mb-4 bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent"
                >
                  {benefit.improvement}
                </motion.div>
      ...
      {/* CTA Section */}
      <section className="py-12 lg:py-20 bg-gradient-to-r from-green-600 to-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-lg lg:text-xl mb-6 lg:mb-8 text-green-100 max-w-2xl mx-auto">
      ...
      <section className="py-12 lg:py-20 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h3 className="text-2xl lg:text-3xl font-bold mb-4">Calculate Your Potential Savings</h3>
            <p className="text-gray-400 mb-6 lg:mb-8">See how much you can save with intelligent inventory optimization</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6 mt-6 lg:mt-8">
              {[
                ...
                <motion.div
                  ...
                  whileInView={{ opacity: 1, scale: 1 }}
                  transition={{ duration: 0.5, delay: index * 0.1 }}
                  className="bg-gray-800 rounded-xl p-4 lg:p-6"
                >
                  <div className="text-xl lg:text-2xl font-bold text-green-400 mb-2">{item.value}</div>
                  <div className="text-gray-400 text-xs lg:text-sm">{item.label}</div>
                </motion.div>
              ))}
            </div>
          </motion.div>
