...
const pricingTiers = [
  {
    ...
    icon: '🚚',
    price: 499,
    description: 'Perfect for small businesses looking to optimize basic logistics and transportation.',
    features: [
      { text: 'Route Optimization', included: true },
      { text: 'Basic Inventory Management', included: true },
      { text: 'Carrier Management', included: true },
      { text: 'Basic Analytics Dashboard', included: true },
      { text: 'Advanced Warehouse Management', included: false },
      { text: 'Real-time Tracking', included: false },
      { text: 'Dedicated Logistics Manager', included: false },
      { text: 'Custom Supply Chain Solutions', included: false },
    ],
    highlight: false,
    buttonText: 'Start Logistics',
    popular: false
  },
  {
    id: 'professional',
    name: 'Professional Supply Chain',
    icon: '📦',
    price: 1299,
    description: 'Comprehensive supply chain solutions for growing businesses with advanced needs.',
    features: [
      { text: 'Advanced Route Optimization', included: true },
      { text: 'Warehouse Management System', included: true },
      { text: 'Inventory Optimization', included: true },
      { text: 'Real-time Shipment Tracking', included: true },
      { text: 'Advanced Analytics & Reporting', included: true },
      { text: 'Multi-carrier Management', included: true },
      { text: 'Dedicated Logistics Manager', included: false },
      { text: 'Custom Supply Chain Solutions', included: false },
    ],
    highlight: true,
    buttonText: 'Optimize Supply Chain',
    popular: true
  },
  {
    id: 'enterprise',
    ...
    icon: '🌐',
    price: 2999,
    description: 'End-to-end supply chain solutions for large organizations with complex requirements.',
    features: [
      { text: 'End-to-End Supply Chain Management', included: true },
      { text: 'Advanced Warehouse Automation', included: true },
      { text: 'Predictive Analytics & AI', included: true },
      { text: 'Custom Logistics Software', included: true },
      { text: 'Real-time Performance Monitoring', included: true },
      { text: 'Global Logistics Support', included: true },
      { text: 'Dedicated Logistics Manager', included: true },
      { text: 'Custom Supply Chain Solutions', included: true },
    ],
    highlight: false,
...
const PlanCard = ({ plan, onSelect, delay = 0 }) => {
  ...
  // Conditional classes for highlighting the Professional plan
  const cardClasses = isHighlighted
    ? 'bg-white border-4 border-green-500 shadow-2xl scale-[1.02] hover:scale-[1.05] transition-all duration-500 animate-pop-in'
  ...
  const headerClasses = isHighlighted
    ? 'bg-gradient-to-r from-green-600 to-emerald-600 text-white p-6 rounded-t-lg'
  ...
  return (
    ...
    >
      ...
      {isHighlighted && (
        <div className="absolute inset-0 bg-gradient-to-r from-green-600 to-emerald-600 opacity-5 rounded-2xl"></div>
      )}
      ...
      <div className={headerClasses}>
        ...
        <p className={`text-sm mb-4 ${isHighlighted ? 'text-green-200' : 'text-gray-500'} animate-fade-in delay-100`}>
          {plan.description}
        </p>
        ...
        <div className="flex items-baseline animate-scale-in">
          ...
          <span className={`ml-1 text-xl font-medium ${isHighlighted ? 'text-green-200' : 'text-gray-500'}`}>
            /month
          </span>
        </div>
      </div>
...
const CheckoutPage = ({ planId, onBack, onComplete }) => {
    ...
    if (!plan) {
        return (
            <div className="text-center p-20 animate-fade-in">
                ...
                <button 
                    onClick={onBack}
                    className="mt-4 py-2 px-6 bg-green-500 text-white rounded-lg hover:bg-green-600 transition transform hover:scale-105">
                    Back to Plans
                </button>
            </div>
        );
    ...
    return (
        <div className="max-w-xl mx-auto p-8 bg-white rounded-2xl shadow-2xl animate-slide-up border border-green-100">
            <div className="animate-fade-in">
                ...
                <ul className="space-y-3 mb-8 text-sm text-gray-600 bg-gradient-to-r from-gray-50 to-green-50 p-6 rounded-xl animate-fade-in delay-300">
                    <li className="font-semibold text-green-600">Key Features:</li>
                ...
                {/* Additional Supply Chain Services Info */}
                <div className="mb-6 p-4 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl border border-blue-200 animate-fade-in delay-600">
                    ...
                    <ul className="text-sm text-blue-700 space-y-1">
                        <li>• Dedicated logistics team</li>
                        <li>• 99.5% on-time delivery guarantee</li>
                ...
                <div className="flex justify-between items-center pt-6 border-t animate-fade-in delay-700">
                    <button onClick={onBack}
                        className="text-green-600 hover:text-green-800 transition transform hover:scale-105 font-semibold">
                        &larr; Change Plan
                    </button>
                    <button 
...
const SubscriptionView = ({ handleSubscription }) => (
    <div className="max-w-7xl mx-auto pt-10 pb-20">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 mb-6 tracking-tight bg-gradient-to-r from-gray-900 to-green-600 bg-clip-text text-transparent">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed animate-fade-in-up delay-300">
            Optimize your logistics and transform your supply chain. From basic logistics to enterprise solutions, we have the perfect plan for your business needs.
          </p>
          ...
          <div className="grid grid-cols-3 gap-8 mt-12 max-w-2xl mx-auto">
            {[
              ...
              { number: '24/7', label: 'Logistics Support' },
        ...
        {/* Enterprise CTA */}
        <div className="mt-16 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-8 text-center animate-fade-in delay-1000 border border-green-100">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">Need Custom Enterprise Logistics?</h3>
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            We offer tailored supply chain solutions for large organizations with specific requirements. 
            Get a custom quote with dedicated logistics managers and premium support.
          </p>
          <Link to="/contact" className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white px-8 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105">
            Contact Logistics Experts
          </Link>
        </div>
    </div>
);
...
const Subscription = () => {
  ...
  const handlePurchaseComplete = () => {
    setMessage(`🎉 Subscription complete! Welcome to ${selectedPlanId}! Our logistics team will contact you within 2 hours.`);
  ...
  return (
    <div className="font-sans bg-gradient-to-br from-gray-50 via-green-50 to-emerald-50 min-h-screen p-4 sm:p-8 pt-24">
      {/* Global Message Box with enhanced animation */}
      {message && (
        <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 p-4 rounded-xl bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold shadow-2xl transition-all duration-500 animate-slide-down">
          <div className="flex items-center space-x-2">
