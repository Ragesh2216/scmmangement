  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-blue-900 overflow-x-hidden">
      ...
      <div className="relative overflow-hidden w-full">
        {/* Animated Background Elements - Fixed with proper containment */}
        ...
        <div className="relative z-10 w-full">
          <div className="py-6 min-[320px]:py-8 px-3 min-[320px]:px-4 sm:px-6 lg:px-8 pt-16 max-w-7xl mx-auto">
                ...
                >
                  ...
                  {plan.popular && (
                    <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20">
                      <div className="bg-gradient-to-r from-cyan-500 to-blue-500 text-white text-xs min-[320px]:text-sm px-3 min-[320px]:px-4 py-1 min-[320px]:py-1.5 rounded-full shadow-lg">
                        Most Popular
                      </div>
                    </div>
                  )}
                      ...
                      <ul className="space-y-2 min-[320px]:space-y-3 sm:space-y-4">
                        {plan.features.map((feature, featureIndex) => (
                          <li key={featureIndex} className="flex items-start space-x-2 min-[320px]:space-x-3">
                            <span className="w-4 h-4 min-[320box]:w-5 min-[320px]:h-5 bg-green-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
